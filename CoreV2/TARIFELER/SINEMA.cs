...
namespace CoreV2.TARIFELER
{
    public partial class SINEMA : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void COMBO_HESAPLAMA_TURU_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void TXT_BIRIM_FIYAT_EditValueChanged(object sender, EventArgs e)
        {
        ...
        private void BTN_KAYDET_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (lbID.Caption != "")
            { 
                GLOBALTARIFELER.GUNCELLE(lbFILE_NAME.Caption, lbID.Caption, "SINEMA","");
            }
            if (lbID.Caption == "")
            {
                ...
                { lbID.Caption=GLOBALTARIFELER.KAYDET(lbFILE_NAME.Caption, "SINEMA", "", false,"").ToString (); }
            ...
            if (dv != null)
            {
                ...
                GLOBALTARIFELER.SINEMA_ROW_DELETE(dv, lbID.Caption, _GLOBAL_PARAMETRELER._KULLANICI_FIRMA, _GLOBAL_PARAMETRELER._KULLANICI_MAIL);
                // SATIR EKLE
                dv.RowStateFilter = DataViewRowState.Added;
                GLOBALTARIFELER.SINEMA_ROW_ADD(dv, lbFILE_NAME.Caption.ToString(), lbID.Caption, _GLOBAL_PARAMETRELER._KULLANICI_FIRMA, _GLOBAL_PARAMETRELER._KULLANICI_MAIL);
                // SATIR GUNCELLE
                dv.RowStateFilter = DataViewRowState.ModifiedOriginal;
                GLOBALTARIFELER.SINEMA_ROW_UPDATE(dv, lbID.Caption, _GLOBAL_PARAMETRELER._KULLANICI_FIRMA, _GLOBAL_PARAMETRELER._KULLANICI_MAIL);
