...
namespace CoreV2
{
    public partial class _MASTERS_FORM : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        int childCount = 0;
        ...
        private void RAPOR_LIST_LOAD()
        {
            ...
            if (tr._BTN_TYPE == "Tamam")
            {
              ...
              //  re_CHK_AUTO_SAVE. = tr.SELECT_RAPOR_AUTO_SAVE;
